if (function (t, e) {
        ...
        function C(t, e) {
            if (e in t)return e;
            for (var n = e[0].toUpperCase() + e.slice(1), i = e, o = Ye.length; o--;)if (e = Ye[o] + n, e in t)return e;
            return i
        }
        ...
        function I(t, e, n) {
            var i, o, r = 0, s = en.length, a = Z.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = Ge || D(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)c.tweens[s].run(r);
                return a.notifyWith(t, [c, r, n]), 1 > r && l ? n : (a.resolveWith(t, [c]), !1)
            }, c = a.promise({
                elem: t, props: Z.extend({}, e), opts: Z.extend(!0, {specialEasing: {}}, n), originalProperties: e, originalOptions: n, startTime: Ge || D(), duration: n.duration, tweens: [], createTween: function (e, n) {
        ...
        function F(t, e, n, i) {
            ...
            if (Z.isArray(e))Z.each(e, function (e, o) {
                n || En.test(t) ? i(t, o) : F(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
        ...
        var M = [], B = M.slice, U = M.concat, z = M.push, V = M.indexOf, X = {}, Q = X.toString, Y = X.hasOwnProperty, G = {}, J = t.document, K = "2.1.3", Z = function (t, e) {
        ...
        var oe = function (t) {
                ...
                if (!i && I) {
                    ...
                    if (w.qsa && (!L || !L.test(t))) {
                        if (f = d = P, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = E(t), (d = e.getAttribute("id")) ? f = d.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + p(c[l]);
            ...
            var x, w, T, C, k, E, $, N, S, D, A, j, O, _, I, L, R, H, q, P = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, B = n(), U = n(), z = n(), V = function (t, e) {
                return t === e && (A = !0), 0
            }, X = 1 << 31, Q = {}.hasOwnProperty, Y = [], G = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, te = function (t, e) {
            ...
            w = e.support = {}, k = e.isXML = function (t) {
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !I || R && R.test(n) || L && L.test(n)))try {
                    var i = H.call(t, n);
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, E = e.tokenize = function (t, n) {
                ...
                return (c || $(t, d))(i, e, !I, n, be.test(t) && u(e.parentNode) || e), n
        ...
        var $e = /^key/, Ne = /^(?:mouse|pointer|contextmenu)|click/, Se = /^(?:focusinfocus|focusoutblur)$/, De = /^([^.]*)(?:\.(.+)|)$/;
        Z.event = {
            global: {}, add: function (t, e, n, i, o) {
                ...
                var r, s, a, l, c, u, d, p = [i || J], f = Y.call(e, "type") ? e.type : e, h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                ...
                for (s || (this.fixHooks[o] = s = Ne.test(o) ? this.mouseHooks : $e.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        qe.optgroup = qe.option, qe.tbody = qe.tfoot = qe.colgroup = qe.caption = qe.thead, qe.th = qe.td, Z.extend({
            clone: function (t, e, n) {
                ...
                if (!(G.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || Z.isXMLDoc(t)))for (s = v(a), r = v(t), i = 0, o = r.length; o > i; i++)y(r[i], s[i]);
        ...
        var Ue = /^(none|table(?!-c[ea]).+)/, ze = new RegExp("^(" + we + ")(.*)$", "i"), Ve = new RegExp("^([+-])=(" + we + ")", "i"), Xe = {position: "absolute", visibility: "hidden", display: "block"}, Qe = {letterSpacing: "0", fontWeight: "400"}, Ye = ["Webkit", "O", "Moz", "ms"];
        Z.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
                ...
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    return e = Z.cssProps[a] || (Z.cssProps[a] = C(l, a)), s = Z.cssHooks[e] || Z.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Ve.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)), r = "number"), null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set"in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n)), void 0)
                }
        ...
        var Ge, Je, Ke = /^(?:toggle|show|hide)$/, Ze = new RegExp("^(?:([+-])=|)(" + we + ")([a-z%]*)$", "i"), tn = /queueHooks$/, en = [O], nn = {
            "*": [function (t, e) {
        ...
        Z.fn.extend({
            ...
            attr: function (t, e, n) {
                ...
                if (t && 3 !== r && 8 !== r && 2 !== r)return typeof t.getAttribute === Ee ? Z.prop(t, e, n) : (1 === r && Z.isXMLDoc(t) || (e = e.toLowerCase(), i = Z.attrHooks[e] || (Z.expr.match.bool.test(e) ? rn : on)), void 0 === n ? i && "get"in i && null !== (o = i.get(t, e)) ? o : (o = Z.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set"in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void Z.removeAttr(t, e))
        ...
        Z.fn.extend({
            addClass: function (t) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ? function (n) {
                    ...
                    if ("string" === n)for (var e, i = 0, o = Z(this), r = t.match(fe) || []; e = r[i++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else(n === Ee || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ve.get(this, "__className__") || "")
                })
            }, hasClass: function (t) {
        ...
        }), G.cors = !!On && "withCredentials"in On, G.ajax = On = !!On, Z.ajaxTransport(function (t) {
            var e;
        ...
        Z.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(In, "$1" + o) : e.jsonp !== !1 && (e.url += (dn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
        ...
        Z.offset = {
            ...
            offset: function (t) {
                ...
                if (r)return e = r.documentElement, Z.contains(e, i) ? (typeof i.getBoundingClientRect !== Ee && (o = i.getBoundingClientRect()), n = W(r), {top: o.top + n.pageYOffset - e.clientTop, left: o.left + n.pageXOffset - e.clientLeft}) : o
            }, position: function () {
                if (this[0]) {
...
+function (t) {
    ...
    _determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), t.fn[l] = function (r, s) {
        ...
        return (v == u || v == d) && (a = 'input[type="' + v + '"]'), -50 > C && (C = -50), g(this), f.each(function () {
            var r = t(this);
            o(r);
            var s, a = this, f = a.id, g = -C + "%", v = 100 + 2 * C + "%", k = {position: "absolute", top: g, left: g, display: "block", width: v, height: v, margin: 0, padding: 0, background: "#fff", border: 0, opacity: 0}, E = _mobile ? {
                position: "absolute",
                visibility: "hidden"
            } : C ? k : {
                position: "absolute",
                opacity: 0
            }, $ = a[_type] == u ? m.checkboxClass || "i" + u : m.radioClass || "i" + d, N = t(_label + '[for="' + f + '"]').add(r.closest(_label)), S = !!m.aria, D = l + "-" + Math.random().toString(36).substr(2, 6), A = '<div class="' + $ + '" ' + (S ? 'role="' + a[_type] + '" ' : "");
            S && N.each(function () {
                ...
                o: m,
                s: r.attr("style")
            }).css(E), !!m.inheritClass && A[_add](a.className || ""), !!m.inheritID && f && A.attr("id", l + "-" + f), "static" == A.css("position") && A.css("position", "relative"), e(r, !0, _update), N.length && N.on(_click + ".i mouseover.i mouseout.i " + _touch, function (n) {
    ...
    $("#project-list").is(":visible") && $("#project-list").load("/deploy/projectslist")
});
if (function (t, e) {
        ...
        function w(t, e, n) {
            ...
            return n = n || Be(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Me.test(s) && We.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function E(t, e, n) {
            var i = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = Be(t), s = "border-box" === Z.css(t, "boxSizing", !1, r);
            if (0 >= o || null == o) {
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, c, u, p = this, d = {}, f = t.style, h = t.nodeType && Ce(t), g = ve.get(t, "fxshow");
            ...
            if (Z.isEmptyObject(d))"inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c); else {
                g ? "hidden"in g && (h = g.hidden) : g = ve.access(t, "fxshow", {}), r && (g.hidden = !h), h ? Z(t).show() : p.done(function () {
                    Z(t).hide()
                }), p.done(function () {
                    var e;
                    ve.remove(t, "fxshow");
                ...
                for (i in d)s = j(h ? g[i] : 0, i, p), i in g || (g[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function I(t, e, n) {
            ...
            for (_(u, c.opts.specialEasing); s > r; r++)if (i = en[r].call(c, t, u, c.opts))return i;
        ...
        var M = [], B = M.slice, U = M.concat, z = M.push, V = M.indexOf, X = {}, Q = X.toString, G = X.hasOwnProperty, Y = {}, J = t.document, K = "2.1.3", Z = function (t, e) {
        ...
        var oe = function (t) {
            function e(t, e, n, i) {
                ...
                if (!i && I) {
                    ...
                    if (w.qsa && (!L || !L.test(t))) {
                        if (f = p = P, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = $(t), (p = e.getAttribute("id")) ? f = p.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + d(c[l]);
                ...
                return o && !o[P] && (o = v(o)), r && !r[P] && (r = v(r, s)), i(function (i, s, a, l) {
                    ...
                    if (i) {
                        if (r || t) {
                            ...
                            for (u = b.length; u--;)(p = b[u]) && (c = r ? te(i, p) : d[u]) > -1 && (i[c] = !(s[c] = p))
                        }
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, p, d, f = 0, h = "0", g = i && [], v = [], y = S, b = i || r && T.find.TAG("*", c), x = W += null == y ? 1 : Math.random() || .1, w = b.length;
            ...
            var x, w, T, C, k, $, E, N, S, D, A, j, O, _, I, L, R, H, q, P = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, B = n(), U = n(), z = n(), V = function (t, e) {
                return t === e && (A = !0), 0
            }, X = 1 << 31, Q = {}.hasOwnProperty, G = [], Y = G.pop, J = G.push, K = G.push, Z = G.slice, te = function (t, e) {
                for (var n = 0, i = t.length; i > n; n++)if (t[n] === e)return n;
                return -1
            }, ee = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = ie.replace("w", "w#"), re = "\\[" + ne + "*(" + ie + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + oe + "))|)" + ne + "*\\]", se = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + re + ")*)|.*)\\)|)", ae = new RegExp(ne + "+", "g"), le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"), ce = new RegExp("^" + ne + "*," + ne + "*"), ue = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), pe = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), de = new RegExp(se), fe = new RegExp("^" + oe + "$"), he = {
                ID: new RegExp("^#(" + ie + ")"),
                CLASS: new RegExp("^\\.(" + ie + ")"),
            ...
            w = e.support = {}, k = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, _ = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), I = !k(i), w.attributes = o(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), w.getElementsByTagName = o(function (t) {
                    return t.appendChild(i.createComment("")), !t.getElementsByTagName("*").length
                }), w.getElementsByClassName = ve.test(i.getElementsByClassName), w.getById = o(function (t) {
                    return _.appendChild(t).id = P, !i.getElementsByName || !i.getElementsByName(P).length
                ...
                })), (w.matchesSelector = ve.test(H = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && o(function (t) {
                    w.disconnectedMatch = H.call(t, "div"), H.call(t, "[s!='']:x"), R.push("!=", se)
                }), L = L.length && new RegExp(L.join("|")), R = R.length && new RegExp(R.join("|")), e = ve.test(_.compareDocumentPosition), q = e || ve.test(_.contains) ? function (t, e) {
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(pe, "='$1']"), !(!w.matchesSelector || !I || R && R.test(n) || L && L.test(n)))try {
                    var i = H.call(t, n);
                ...
                var n = T.attrHandle[e.toLowerCase()], i = n && Q.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !I) : void 0;
                ...
                cacheLength: 50, createPseudo: i, match: he, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return he.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && de.test(n) && (e = $(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                }, filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[P] || (m[P] = {}), c = u[t] || [], f = c[0] === W && c[1], d = c[0] === W && c[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (d = f = 0) || h.pop();)if (1 === p.nodeType && ++d && p === e) {
                                        u[t] = [W, f, d];
                                        break
                                    }
                                } else if (y && (c = (e[P] || (e[P] = {}))[t]) && c[0] === W)d = c[1]; else for (; (p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[P] || (p[P] = {}))[t] = [W, d]), p !== e)););
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, $ = e.tokenize = function (t, n) {
                ...
                return (c || E(t, p))(i, e, !I, n, be.test(t) && u(e.parentNode) || e), n
        ...
        Z.extend({
            ...
            Z.fn[t] = function (n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (de[t] || Z.unique(o), pe.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var fe = /\S+/g, he = {};
        Z.Callbacks = function (t) {
            ...
            Deferred: function (t) {
                ...
                var e, n, i, o = 0, r = B.call(arguments), s = r.length, a = 1 !== s || t && Z.isFunction(t.promise) ? s : 0, l = 1 === a ? t : Z.Deferred(), c = function (t, n, i) {
                    return function (o) {
        ...
        Z.event = {
            global: {}, add: function (t, e, n, i, o) {
                ...
                if (m)for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                ...
                }), e = (e || "").match(fe) || [""], c = e.length; c--;)a = De.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (p = Z.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = Z.event.special[f] || {}, u = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (d = l[f]) || (d = l[f] = [], d.delegateCount = 0, p.setup && p.setup.call(t, i, h, s) !== !1 || t.addEventListener && t.addEventListener(f, s, !1)), p.add && (p.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), Z.event.global[f] = !0)
                ...
                if (m && (l = m.events)) {
                    for (e = (e || "").match(fe) || [""], c = e.length; c--;)if (a = De.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                        for (p = Z.event.special[f] || {}, f = (i ? p.delegateType : p.bindType) || f, d = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;)u = d[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1), u.selector && d.delegateCount--, p.remove && p.remove.call(t, u));
                        s && !d.length && (p.teardown && p.teardown.call(t, h, m.handle) !== !1 || Z.removeEvent(t, f, m.handle), delete l[f])
                    } else for (f in l)Z.event.remove(t, f + e[c], n, i, !0);
                    Z.isEmptyObject(l) && (delete m.handle, ve.remove(t, "events"))
                }
            }, trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, p, d = [i || J], f = G.call(e, "type") ? e.type : e, h = G.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), p = Z.event.special[f] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                    if (!o && !p.noBubble && !Z.isWindow(i)) {
                        for (l = p.delegateType || f, Se.test(l + f) || (s = s.parentNode); s; s = s.parentNode)d.push(s), a = s;
                        a === (i.ownerDocument || J) && d.push(a.defaultView || a.parentWindow || t)
                    }
                    for (r = 0; (s = d[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : p.bindType || f, u = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
                    return e.type = f, o || e.isDefaultPrevented() || p._default && p._default.apply(d.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[f]) && !Z.isWindow(i) && (a = i[c], a && (i[c] = null), Z.event.triggered = f, i[f](), Z.event.triggered = void 0, a && (i[c] = a)), e.result
                }
            }, dispatch: function (t) {
                t = Z.event.fix(t);
                var e, n, i, o, r, s = [], a = B.call(arguments), l = (ve.get(this, "events") || {})[t.type] || [], c = Z.event.special[t.type] || {};
        ...
        var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, je = /<([\w:]+)/, Oe = /<|&#?\w+;/, _e = /<(?:script|style|link)/i, Ie = /checked\s*(?:[^=]|=\s*.checked.)/i, Le = /^$|\/(?:java|ecma)script/i, Re = /^true\/(.*)/, He = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, qe = {
        ...
        qe.optgroup = qe.option, qe.tbody = qe.tfoot = qe.colgroup = qe.caption = qe.thead, qe.th = qe.td, Z.extend({
            clone: function (t, e, n) {
                ...
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++)if (o = t[d], o || 0 === o)if ("object" === Z.type(o))Z.merge(p, o.nodeType ? [o] : o); else if (Oe.test(o)) {
                ...
                for (u.textContent = "", d = 0; o = p[d++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))for (c = 0; o = r[c++];)Le.test(o.type || "") && n.push(o);
                return u
            ...
            text: function (t) {
                ...
                return me(this, function (t) {
                    ...
                    if ("string" == typeof t && !_e.test(t) && !qe[(je.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Ae, "<$1></$2>");
                        try {
                ...
                t = U.apply([], t);
                var n, i, o, r, s, a, l = 0, c = this.length, u = this, p = c - 1, d = t[0], g = Z.isFunction(d);
                if (g || c > 1 && "string" == typeof d && !Y.checkClone && Ie.test(d))return this.each(function (n) {
                    var i = u.eq(n);
        ...
        var Pe, Fe = {}, We = /^margin/, Me = new RegExp("^(" + we + ")(?!px)[a-z%]+$", "i"), Be = function (e) {
        ...
        var Ue = /^(none|table(?!-c[ea]).+)/, ze = new RegExp("^(" + we + ")(.*)$", "i"), Ve = new RegExp("^([+-])=(" + we + ")", "i"), Xe = {position: "absolute", visibility: "hidden", display: "block"}, Qe = {letterSpacing: "0", fontWeight: "400"}, Ge = ["Webkit", "O", "Moz", "ms"];
        Z.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
            ...
            css: function (t, e) {
                return me(this, function (t, e, n) {
                    var i, o, r = {}, s = 0;
                    if (Z.isArray(e)) {
                        for (i = Be(t), o = e.length; o > s; s++)r[e[s]] = Z.css(t, e[s], !1, i);
                        return r
                    }
        ...
        Z.extend({
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, u, v, y, x, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", w.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = q(p, w, n)), y = P(p, y, w, l), l ? (p.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (Z.etag[o] = x)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, u = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || T) + "", l ? h.resolveWith(d, [u, T, w]) : h.rejectWith(d, [w, T, v]), w.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [w, p, l ? u : v]), g.fireWith(d, [w, T]), c && (f.trigger("ajaxComplete", [w, p]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, c, u, p = Z.ajaxSetup({}, e), d = p.context || p, f = p.context && (d.nodeType || d.jquery) ? Z(d) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0,
        ...
        Z.ajaxSetup({
            jsonp: "callback", jsonpCallback: function () {
                var t = _n.pop() || Z.expando + "_" + un++;
                return this[t] = !0, t
            }
        }), Z.ajaxPrefilter("json jsonp", function (e, n, i) {
            var o, r, s, a = e.jsonp !== !1 && (In.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && In.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(In, "$1" + o) : e.jsonp !== !1 && (e.url += (pn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                ...
                t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, _n.push(o)), s && Z.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        Z.offset = {
            setOffset: function (t, e, n) {
                var i, o, r, s, a, l, c, u = Z.css(t, "position"), p = Z(t), d = {};
...
+function (t) {
    ...
    n.VERSION = "3.3.2", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        var p = /top|bottom/.test(n), d = p ? 2 * u.left - o + l : 2 * u.top - r + c, f = p ? "offsetWidth" : "offsetHeight";
    ...
    function e(t, e, o) {
        var r = t[0], s = /er/.test(o) ? _indeterminate : /bl/.test(o) ? h : d, a = o == _update ? {checked: r[d], disabled: r[h], indeterminate: "true" == t.attr(_indeterminate) || "false" == t.attr(_determinate)} : r[s];
        if (/^(ch|di|in)/.test(o) && !a)n(t, s); else if (/^(un|en|de)/.test(o) && a)i(t, s); else if (o == _update)for (var l in a)a[l] ? n(t, l, !0) : i(t, l, !0); else e && "toggle" != o || (e || t[_callback]("ifClicked"), a ? r[_type] !== p && i(t, s) : n(t, s))
    }

    function n(e, n, o) {
        var u = e[0], g = e.parent(), m = n == d, v = n == _indeterminate, y = n == h, b = v ? _determinate : m ? f : "enabled", x = r(e, b + s(u[_type])), w = r(e, n + s(u[_type]));
        if (u[n] !== !0) {
            if (!o && n == d && u[_type] == p && u.name) {
                var T = e.closest("form"), C = 'input[name="' + u.name + '"]';
                C = T.length ? T.find(C) : t(C), C.each(function () {
                    this !== u && t(this).data(l) && i(t(this), n)
                })
            }
            v ? (u[n] = !0, u[d] && i(e, d, "force")) : (o || (u[n] = !0), m && u[_indeterminate] && i(e, _indeterminate, !1)), a(e, m, n, o)
        }
        u[h] && r(e, _cursor, !0) && g.find("." + c).css(_cursor, "default"), g[_add](w || r(e, n) || ""), g.attr("role") && !v && g.attr("aria-" + (y ? h : d), "true"), g[_remove](x || r(e, b) || "")
    }

    function i(t, e, n) {
        var i = t[0], o = t.parent(), l = e == d, u = e == _indeterminate, p = e == h, g = u ? _determinate : l ? f : "enabled", m = r(t, g + s(i[_type])), v = r(t, e + s(i[_type]));
        i[e] !== !1 && ((u || !n || "force" == n) && (i[e] = !1), a(t, l, g, n)), !i[h] && r(t, _cursor, !0) && o.find("." + c).css(_cursor, "pointer"), o[_remove](v || r(t, e) || ""), o.attr("role") && !u && o.attr("aria-" + (p ? h : d), "false"), o[_add](m || r(t, g) || "")
    }
    ...
    var l = "iCheck", c = l + "-helper", u = "checkbox", p = "radio", d = "checked", f = "un" + d, h = "disabled";
    _determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), t.fn[l] = function (r, s) {
        var a = 'input[type="' + u + '"], input[type="' + p + '"]', f = t(), g = function (e) {
            e.each(function () {
                var e = t(this);
        ...
        return (v == u || v == p) && (a = 'input[type="' + v + '"]'), -50 > C && (C = -50), g(this), f.each(function () {
            var r = t(this);
            o(r);
            var s, a = this, f = a.id, g = -C + "%", v = 100 + 2 * C + "%", k = {position: "absolute", top: g, left: g, display: "block", width: v, height: v, margin: 0, padding: 0, background: "#fff", border: 0, opacity: 0}, $ = _mobile ? {
                ...
                position: "absolute",
                opacity: 0
            }, E = a[_type] == u ? m.checkboxClass || "i" + u : m.radioClass || "i" + p, N = t(_label + '[for="' + f + '"]').add(r.closest(_label)), S = !!m.aria, D = l + "-" + Math.random().toString(36).substr(2, 6), A = '<div class="' + E + '" ' + (S ? 'role="' + a[_type] + '" ' : "");
            S && N.each(function () {
                ...
                return e == _click ? !1 : "keydown" == e && 32 == o ? (a[_type] == p && a[d] || (a[d] ? i(r, d) : n(r, d)), !1) : void("keyup" == e && a[_type] == p ? !a[d] && n(r, d) : /us|ur/.test(e) && A["blur" == e ? _remove : _add](b))

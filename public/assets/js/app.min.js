if (function (t, e) {
        ...
        function m(t, e) {
            var n, i, o, r, s, a, l, u;
            if (1 === e.nodeType) {
                if (ve.hasData(t) && (r = ve.access(t), s = ve.set(e, r), u = r.events)) {
                    delete s.handle, s.events = {};
                    for (o in u)for (n = 0, i = u[o].length; i > n; n++)Z.event.add(e, o, u[o][n])
                }
        ...
        function x(t) {
            var e = J, n = We[t];
            return n || (n = b(t, e), "none" !== n && n || (Fe = (Fe || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Fe[0].contentDocument, e.write(), e.close(), n = b(t, e), Fe.detach()), We[t] = n), n
        }

        function w(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Ue(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Be.test(s) && Me.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, u, c, p = this, f = {}, d = t.style, h = t.nodeType && Ce(t), g = ve.get(t, "fxshow");
            ...
            })), 1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], u = Z.css(t, "display"), c = "none" === u ? ve.get(t, "olddisplay") || x(t.nodeName) : u, "inline" === c && "none" === Z.css(t, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", p.always(function () {
            ...
            for (i in e)if (o = e[i], Ke.exec(o)) {
                ...
                f[i] = g && g[i] || Z.style(t, i)
            } else u = void 0;
            if (Z.isEmptyObject(f))"inline" === ("none" === u ? x(t.nodeName) : u) && (d.display = u); else {
                ...
                for (i in f)s = j(h ? g[i] : 0, i, p), i in g || (g[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function L(t, e, n) {
            var i, o, r = 0, s = en.length, a = Z.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = Ge || D(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; l > s; s++)u.tweens[s].run(r);
            ...
            for (I(c, u.opts.specialEasing); s > r; r++)if (i = en[r].call(u, t, c, u.opts))return i;
            return Z.map(c, j, u), Z.isFunction(u.opts.start) && u.opts.start.call(t, u), Z.fx.timer(Z.extend(l, {elem: t, anim: u, queue: u.opts.queue})), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always)
        }

        function R(t) {
            return function (e, n) {
                "string" != typeof e && (n = e, e = "*");
                var i, o = 0, r = e.toLowerCase().match(de) || [];
        ...
        function W(t, e, n, i) {
            ...
            if (Z.isArray(e))Z.each(e, function (e, o) {
                n || $n.test(t) ? i(t, o) : W(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            }); else if (n || "object" !== Z.type(e))i(t, e); else for (o in e)W(t + "[" + o + "]", e[o], n, i)
        }
        ...
        var B = [], U = B.slice, _ = B.concat, z = B.push, V = B.indexOf, X = {}, Q = X.toString, Y = X.hasOwnProperty, G = {}, J = t.document, K = "2.1.3", Z = function (t, e) {
        ...
        Z.fn = Z.prototype = {
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || Z.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)if (null != (t = arguments[a]))for (e in t)n = s[e], i = t[e], s !== i && (u && i && (Z.isPlainObject(i) || (o = Z.isArray(i))) ? (o ? (o = !1, r = n && Z.isArray(n) ? n : []) : r = n && Z.isPlainObject(n) ? n : {}, s[e] = Z.extend(u, r, i)) : void 0 !== i && (s[e] = i));
            return s
        }, Z.extend({
        ...
        var oe = function (t) {
            function e(t, e, n, i) {
                var o, r, s, a, l, u, p, d, h, g;
                if ((e ? e.ownerDocument || e : W) !== O && j(e), e = e || O, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a)return n;
                if (!i && L) {
                    ...
                    if (w.qsa && (!R || !R.test(t))) {
                        if (d = p = F, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (u = $(t), (p = e.getAttribute("id")) ? d = p.replace(xe, "\\$&") : e.setAttribute("id", d), d = "[id='" + d + "'] ", l = u.length; l--;)u[l] = d + f(u[l]);
                            h = be.test(t) && c(e.parentNode) || e, g = u.join(",")
                        }
                        if (g)try {
            ...
            function v(t, e, n, o, r, s) {
                return o && !o[F] && (o = v(o)), r && !r[F] && (r = v(r, s)), i(function (i, s, a, l) {
                    var u, c, p, f = [], d = [], h = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : m(v, f, t, a, l), b = n ? r || (i ? t : h || o) ? [] : s : y;
                    if (n && n(y, b, a, l), o)for (u = m(b, d), o(u, [], a, l), c = u.length; c--;)(p = u[c]) && (b[d[c]] = !(y[d[c]] = p));
                    if (i) {
                        if (r || t) {
                            if (r) {
                            ...
                            for (c = b.length; c--;)(p = b[c]) && (u = r ? te(i, p) : f[c]) > -1 && (i[u] = !(s[u] = p))
                        }
            ...
            function y(t) {
                for (var e, n, i, o = t.length, r = T.relative[t[0].type], s = r || T.relative[" "], a = r ? 1 : 0, l = d(function (t) {
                    ...
                    return e = null, o
                }]; o > a; a++)if (n = T.relative[t[a].type])c = [d(h(c), n)]; else {
                    if (n = T.filter[t[a].type].apply(null, t[a].matches), n[F]) {
                        for (i = ++a; o > i && !T.relative[t[i].type]; i++);
                        return v(a > 1 && h(c), a > 1 && f(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(le, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && f(t))
                    }
                    c.push(n)
                }
                return h(c)
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, u) {
                    var c, p, f, d = 0, h = "0", g = i && [], v = [], y = S, b = i || r && T.find.TAG("*", u), x = M += null == y ? 1 : Math.random() || .1, w = b.length;
                    for (u && (S = s !== O && s); h !== w && null != (c = b[h]); h++) {
                        if (r && c) {
                            for (p = 0; f = t[p++];)if (f(c, s, a)) {
                                l.push(c);
                                break
                            }
                            u && (M = x)
            ...
            var x, w, T, C, E, $, k, N, S, D, A, j, O, I, L, R, H, q, P, F = "sizzle" + 1 * new Date, W = t.document, M = 0, B = 0, U = n(), _ = n(), z = n(), V = function (t, e) {
                return t === e && (A = !0), 0
            }, X = 1 << 31, Q = {}.hasOwnProperty, Y = [], G = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, te = function (t, e) {
                for (var n = 0, i = t.length; i > n; n++)if (t[n] === e)return n;
                return -1
            }, ee = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = ie.replace("w", "w#"), re = "\\[" + ne + "*(" + ie + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + oe + "))|)" + ne + "*\\]", se = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + re + ")*)|.*)\\)|)", ae = new RegExp(ne + "+", "g"), le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"), ue = new RegExp("^" + ne + "*," + ne + "*"), ce = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), pe = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), fe = new RegExp(se), de = new RegExp("^" + oe + "$"), he = {
                ID: new RegExp("^#(" + ie + ")"),
                CLASS: new RegExp("^\\.(" + ie + ")"),
            ...
            w = e.support = {}, E = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), L = !E(i), w.attributes = o(function (t) {
                ...
                }, H = [], R = [], (w.qsa = ve.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (w.matchesSelector = ve.test(q = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function (t) {
                    w.disconnectedMatch = q.call(t, "div"), q.call(t, "[s!='']:x"), H.push("!=", se)
                }), R = R.length && new RegExp(R.join("|")), H = H.length && new RegExp(H.join("|")), e = ve.test(I.compareDocumentPosition), P = e || ve.test(I.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === W && P(W, t) ? -1 : e === i || e.ownerDocument === W && P(W, e) ? 1 : D ? te(D, t) - te(D, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return A = !0, 0;
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(pe, "='$1']"), !(!w.matchesSelector || !L || H && H.test(n) || R && R.test(n)))try {
                    var i = q.call(t, n);
                ...
                var n = T.attrHandle[e.toLowerCase()], i = n && Q.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !L) : void 0;
                ...
                cacheLength: 50, createPseudo: i, match: he, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return he.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && fe.test(n) && (e = $(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                }, filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var u, c, p, f, d, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                            if (m) {
                                if (r) {
                                    for (; g;) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (c = m[F] || (m[F] = {}), u = c[t] || [], d = u[0] === M && u[1], f = u[0] === M && u[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (f = d = 0) || h.pop();)if (1 === p.nodeType && ++f && p === e) {
                                        c[t] = [M, d, f];
                                        break
                                    }
                                } else if (y && (u = (e[F] || (e[F] = {}))[t]) && u[0] === M)f = u[1]; else for (; (p = ++d && p && p[g] || (f = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++f || (y && ((p[F] || (p[F] = {}))[t] = [M, f]), p !== e)););
                    ...
                    not: i(function (t) {
                        ...
                        return de.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(we, Te).toLowerCase(), function (e) {
                            var n;
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, $ = e.tokenize = function (t, n) {
                ...
                for (a = t, l = [], u = T.preFilter; a;) {
                    (!i || (o = ue.exec(a))) && (o && (a = a.slice(o[0].length) || a), l.push(r = [])), i = !1, (o = ce.exec(a)) && (i = o.shift(), r.push({value: i, type: o[0].replace(le, " ")}), a = a.slice(i.length));
                    for (s in T.filter)!(o = he[s].exec(a)) || u[s] && !(o = u[s](o)) || (i = o.shift(), r.push({value: i, type: s, matches: o}), a = a.slice(i.length));
                    if (!i)break
                }
                ...
                var n, i = [], o = [], r = z[t + " "];
                if (!r) {
                    for (e || (e = $(t)), n = e.length; n--;)r = y(e[n]), r[F] ? i.push(r) : o.push(r);
                    r = z(t, b(o, i)), r.selector = t
                }
                return r
            }, N = e.select = function (t, e, n, i) {
                var o, r, s, a, l, u = "function" == typeof t && t, p = !i && $(t = u.selector || t);
                if (n = n || [], 1 === p.length) {
                    if (r = p[0] = p[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && L && T.relative[r[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(we, Te), e) || [])[0], !e)return n;
                        u && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = he.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((l = T.find[a]) && (i = l(s.matches[0].replace(we, Te), be.test(r[0].type) && c(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && f(r), !t)return K.apply(n, i), n;
                        break
                    }
                }
                return (u || k(t, p))(i, e, !L, n, be.test(t) && c(e.parentNode) || e), n
            }, w.sortStable = F.split("").sort(V).join("") === F, w.detectDuplicates = !!A, j(), w.sortDetached = o(function (t) {
        ...
        var le, ue = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ce = Z.fn.init = function (t, e) {
            var n, i;
            if (!t)return this;
            if ("string" == typeof t) {
        ...
        Z.extend({
            ...
            Z.fn[t] = function (n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (fe[t] || Z.unique(o), pe.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var de = /\S+/g, he = {};
        Z.Callbacks = function (t) {
            ...
            var e, n, i, o, s, a, l = [], u = !t.once && [], c = function (r) {
                ...
                add: function () {
                    if (l) {
                        ...
                        }(arguments), i ? s = l.length : e && (o = n, c(e))
                    }
                    return this
                }, remove: function () {
            ...
            Deferred: function (t) {
                ...
                var e, n, i, o = 0, r = U.call(arguments), s = r.length, a = 1 !== s || t && Z.isFunction(t.promise) ? s : 0, l = 1 === a ? t : Z.Deferred(), u = function (t, n, i) {
                    return function (o) {
                        n[t] = this, i[t] = arguments.length > 1 ? U.call(arguments) : o, i === e ? l.notifyWith(n, i) : --a || l.resolveWith(n, i)
                    }
                };
                if (s > 1)for (e = new Array(s), n = new Array(s), i = new Array(s); s > o; o++)r[o] && Z.isFunction(r[o].promise) ? r[o].promise().done(u(o, i, r)).fail(l.reject).progress(u(o, n, e)) : --a;
        ...
        var me = Z.access = function (t, e, n, i, o, r, s) {
            ...
            } else if (void 0 !== i && (o = !0, Z.isFunction(i) || (s = !0), u && (s ? (e.call(t, i), e = null) : (u = e, e = function (t, e, n) {
                    return u.call(Z(t), n)
        ...
        Z.acceptData = function (t) {
            ...
            key: function (t) {
                ...
                if (void 0 === e)this.cache[r] = {}; else {
                    Z.isArray(e) ? i = e.concat(e.map(Z.camelCase)) : (o = Z.camelCase(e), e in s ? i = [e, o] : (i = o, i = i in s ? [i] : i.match(de) || [])), n = i.length;
                    for (; n--;)delete s[i[n]]
                }
            }, hasData: function (t) {
        ...
        var ke = /^key/, Ne = /^(?:mouse|pointer|contextmenu)|click/, Se = /^(?:focusinfocus|focusoutblur)$/, De = /^([^.]*)(?:\.(.+)|)$/;
        Z.event = {
            global: {}, add: function (t, e, n, i, o) {
                var r, s, a, l, u, c, p, f, d, h, g, m = ve.get(t);
                if (m)for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                ...
                }), e = (e || "").match(de) || [""], u = e.length; u--;)a = De.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (p = Z.event.special[d] || {}, d = (o ? p.delegateType : p.bindType) || d, p = Z.event.special[d] || {}, c = Z.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (f = l[d]) || (f = l[d] = [], f.delegateCount = 0, p.setup && p.setup.call(t, i, h, s) !== !1 || t.addEventListener && t.addEventListener(d, s, !1)), p.add && (p.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, c) : f.push(c), Z.event.global[d] = !0)
            }, remove: function (t, e, n, i, o) {
                var r, s, a, l, u, c, p, f, d, h, g, m = ve.hasData(t) && ve.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(de) || [""], u = e.length; u--;)if (a = De.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                        for (p = Z.event.special[d] || {}, d = (i ? p.delegateType : p.bindType) || d, f = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;)c = f[r], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(r, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(t, c));
                        s && !f.length && (p.teardown && p.teardown.call(t, h, m.handle) !== !1 || Z.removeEvent(t, d, m.handle), delete l[d])
                    } else for (d in l)Z.event.remove(t, d + e[u], n, i, !0);
                    Z.isEmptyObject(l) && (delete m.handle, ve.remove(t, "events"))
                }
            }, trigger: function (e, n, i, o) {
                var r, s, a, l, u, c, p, f = [i || J], d = Y.call(e, "type") ? e.type : e, h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, e = e[Z.expando] ? e : new Z.Event(d, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), p = Z.event.special[d] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                    ...
                    for (r = 0; (s = f[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : p.bindType || d, c = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"), c && c.apply(s, n), c = u && s[u], c && c.apply && Z.acceptData(s) && (e.result = c.apply(s, n), e.result === !1 && e.preventDefault());
                    return e.type = d, o || e.isDefaultPrevented() || p._default && p._default.apply(f.pop(), n) !== !1 || !Z.acceptData(i) || u && Z.isFunction(i[d]) && !Z.isWindow(i) && (a = i[u], a && (i[u] = null), Z.event.triggered = d, i[d](), Z.event.triggered = void 0, a && (i[u] = a)), e.result
                }
            }, dispatch: function (t) {
                t = Z.event.fix(t);
                var e, n, i, o, r, s = [], a = U.call(arguments), l = (ve.get(this, "events") || {})[t.type] || [], u = Z.event.special[t.type] || {};
                ...
                for (s || (this.fixHooks[o] = s = Ne.test(o) ? this.mouseHooks : ke.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, je = /<([\w:]+)/, Oe = /<|&#?\w+;/, Ie = /<(?:script|style|link)/i, Le = /checked\s*(?:[^=]|=\s*.checked.)/i, Re = /^$|\/(?:java|ecma)script/i, He = /^true\/(.*)/, qe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Pe = {
        ...
        Pe.optgroup = Pe.option, Pe.tbody = Pe.tfoot = Pe.colgroup = Pe.caption = Pe.thead, Pe.th = Pe.td, Z.extend({
            clone: function (t, e, n) {
                ...
                for (var o, r, s, a, l, u, c = e.createDocumentFragment(), p = [], f = 0, d = t.length; d > f; f++)if (o = t[f], o || 0 === o)if ("object" === Z.type(o))Z.merge(p, o.nodeType ? [o] : o); else if (Oe.test(o)) {
                    for (r = r || c.appendChild(e.createElement("div")), s = (je.exec(o) || ["", ""])[1].toLowerCase(), a = Pe[s] || Pe._default, r.innerHTML = a[1] + o.replace(Ae, "<$1></$2>") + a[2], u = a[0]; u--;)r = r.lastChild;
                    Z.merge(p, r.childNodes), r = c.firstChild, r.textContent = ""
                } else p.push(e.createTextNode(o));
                for (c.textContent = "", f = 0; o = p[f++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(c.appendChild(o), "script"), l && g(r), n))for (u = 0; o = r[u++];)Re.test(o.type || "") && n.push(o);
                return c
            ...
            text: function (t) {
                ...
                t = _.apply([], t);
                var n, i, o, r, s, a, l = 0, u = this.length, c = this, p = u - 1, f = t[0], g = Z.isFunction(f);
                if (g || u > 1 && "string" == typeof f && !G.checkClone && Le.test(f))return this.each(function (n) {
                    var i = c.eq(n);
                ...
                if (u && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    for (o = Z.map(v(n, "script"), d), r = o.length; u > l; l++)s = n, l !== p && (s = Z.clone(s, !0, !0), r && Z.merge(o, v(s, "script"))), e.call(this[l], s, l);
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++)s = o[l], Re.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(qe, "")))
                }
                return this
            }
        ...
        var Fe, We = {}, Me = /^margin/, Be = new RegExp("^(" + we + ")(?!px)[a-z%]+$", "i"), Ue = function (e) {
        ...
        var _e = /^(none|table(?!-c[ea]).+)/, ze = new RegExp("^(" + we + ")(.*)$", "i"), Ve = new RegExp("^([+-])=(" + we + ")", "i"), Xe = {position: "absolute", visibility: "hidden", display: "block"}, Qe = {letterSpacing: "0", fontWeight: "400"}, Ye = ["Webkit", "O", "Moz", "ms"];
        Z.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
            ...
            Z.cssHooks[e] = {
                get: function (t, n, i) {
                    return n ? _e.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Xe, function () {
                        return k(t, e, i)
                    }) : k(t, e, i) : void 0
                }, set: function (t, n, i) {
                    var o = i && Ue(t);
                    return E(t, n, i ? $(t, e, i, "border-box" === Z.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
            ...
            }, Me.test(t) || (Z.cssHooks[t + e].set = E)
        }), Z.fn.extend({
            css: function (t, e) {
        ...
        Z.fn.extend({
            addClass: function (t) {
                ...
                if (a)for (e = (t || "").match(de) || []; u > l; l++)if (n = this[l], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(ln, " ") : " ")) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ? function (n) {
                    ...
                    if ("string" === n)for (var e, i = 0, o = Z(this), r = t.match(de) || []; e = r[i++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else(n === $e || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ve.get(this, "__className__") || "")
                })
            }, hasClass: function (t) {
        ...
        Z.fn.extend({
            val: function (t) {
                var e, n, i, o = this[0];
                {
                    ...
                    if (o)return e = Z.valHooks[o.type] || Z.valHooks[o.nodeName.toLowerCase()], e && "get"in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(un, "") : null == n ? "" : n)
                }
            }
        }), Z.extend({
            valHooks: {
        ...
        Z.extend({
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, c, v, y, x, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", w.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = P(p, w, n)), y = F(p, y, w, l), l ? (p.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (Z.etag[o] = x)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || T) + "", l ? h.resolveWith(f, [c, T, w]) : h.rejectWith(f, [w, T, v]), w.statusCode(m), m = void 0, u && d.trigger(l ? "ajaxSuccess" : "ajaxError", [w, p, l ? c : v]), g.fireWith(f, [w, T]), u && (d.trigger("ajaxComplete", [w, p]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, u, c, p = Z.ajaxSetup({}, e), f = p.context || p, d = p.context && (f.nodeType || f.jquery) ? Z(f) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0,
        ...
        Z.param = function (t, e) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !Z(this).is(":disabled") && Sn.test(this.nodeName) && !Nn.test(t) && (this.checked || !Ee.test(t))
                }).map(function (t, e) {
                    var n = Z(this).val();
                    return null == n ? null : Z.isArray(n) ? Z.map(n, function (t) {
                        return {name: e.name, value: t.replace(kn, "\r\n")}
        ...
        Z.ajaxSetup({
            jsonp: "callback", jsonpCallback: function () {
                var t = In.pop() || Z.expando + "_" + cn++;
                return this[t] = !0, t
            }
        }), Z.ajaxPrefilter("json jsonp", function (e, n, i) {
            var o, r, s, a = e.jsonp !== !1 && (Ln.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ln.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ln, "$1" + o) : e.jsonp !== !1 && (e.url += (pn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
        ...
        Z.offset = {
            setOffset: function (t, e, n) {
                var i, o, r, s, a, l, u, c = Z.css(t, "position"), p = Z(t), f = {};
                "static" === c && (t.style.position = "relative"), a = p.offset(), r = Z.css(t, "top"), l = Z.css(t, "left"), u = ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1, u ? (i = p.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), Z.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + o), "using"in e ? e.using.call(t, f) : p.css(f)
            }
        }, Z.fn.extend({
            offset: function (t) {
                ...
                if (r)return e = r.documentElement, Z.contains(e, i) ? (typeof i.getBoundingClientRect !== $e && (o = i.getBoundingClientRect()), n = M(r), {top: o.top + n.pageYOffset - e.clientTop, left: o.left + n.pageXOffset - e.clientLeft}) : o
            }, position: function () {
                if (this[0]) {
                ...
                return this.map(function () {
                    for (var t = this.offsetParent || Hn; t && !Z.nodeName(t, "html") && "static" === Z.css(t, "position");)t = t.offsetParent;
                    return t || Hn
                })
            }
        ...
        var qn = t.jQuery, Pn = t.$;
        return Z.noConflict = function (e) {
            return t.$ === Z && (t.$ = Pn), e && t.jQuery === Z && (t.jQuery = qn), Z
...
+function (t) {
    ...
    n.VERSION = "3.3.2", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            u && (a = a.replace(l, "") || "top"), r.detach().css({top: 0, left: 0, display: "block"}).addClass(a).data("bs." + this.type, this), this.options.container ? r.appendTo(this.options.container) : r.insertAfter(this.$element);
            ...
            if (u) {
                ...
                a = "bottom" == a && c.bottom + f > g.bottom ? "top" : "top" == a && c.top - f < g.top ? "bottom" : "right" == a && c.right + p > g.width ? "left" : "left" == a && c.left - p < g.left ? "right" : a, r.removeClass(d).addClass(a)
            }
            var m = this.getCalculatedOffset(a, c, p, f);

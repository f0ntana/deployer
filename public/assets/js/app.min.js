if (function (t, e) {
        ...
        function m(t, e) {
            ...
            if (1 === e.nodeType) {
                if (ve.hasData(t) && (r = ve.access(t), s = ve.set(e, r), c = r.events)) {
                    ...
                    for (o in c)for (n = 0, i = c[o].length; i > n; n++)Z.event.add(e, o, c[o][n])
                }
        ...
        function x(t) {
            var e = J, n = Fe[t];
            return n || (n = b(t, e), "none" !== n && n || (Pe = (Pe || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Pe[0].contentDocument, e.write(), e.close(), n = b(t, e), Pe.detach()), Fe[t] = n), n
        }

        function w(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Ue(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Me.test(s) && We.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function C(t, e) {
            if (e in t)return e;
            for (var n = e[0].toUpperCase() + e.slice(1), i = e, o = Ge.length; o--;)if (e = Ge[o] + n, e in t)return e;
            return i
        }
        ...
        function $(t, e, n, i, o) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)"margin" === n && (s += Z.css(t, n + Te[r], !0, o)), i ? ("content" === n && (s -= Z.css(t, "padding" + Te[r], !0, o)), "margin" !== n && (s -= Z.css(t, "border" + Te[r] + "Width", !0, o))) : (s += Z.css(t, "padding" + Te[r], !0, o), "padding" !== n && (s += Z.css(t, "border" + Te[r] + "Width", !0, o)));
            return s
        }

        function E(t, e, n) {
            var i = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = Ue(t), s = "border-box" === Z.css(t, "boxSizing", !1, r);
            if (0 >= o || null == o) {
                if (o = w(t, e, r), (0 > o || null == o) && (o = t.style[e]), Me.test(o))return o;
        ...
        function N(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)i = t[s], i.style && (r[s] = ve.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ce(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : (o = Ce(i), "none" === n && o || ve.set(i, "olddisplay", o ? n : Z.css(i, "display"))));
        ...
        function A(t, e) {
            ...
            for (e = e ? 1 : 0; 4 > i; i += 2 - e)n = Te[i], o["margin" + n] = o["padding" + n] = t;
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, c, u, d = this, p = {}, f = t.style, h = t.nodeType && Ce(t), g = ve.get(t, "fxshow");
            ...
            })), 1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = Z.css(t, "display"), u = "none" === c ? ve.get(t, "olddisplay") || x(t.nodeName) : c, "inline" === u && "none" === Z.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", d.always(function () {
                f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
            }));
            for (i in e)if (o = e[i], Ke.exec(o)) {
            ...
            if (Z.isEmptyObject(p))"inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c); else {
                g ? "hidden"in g && (h = g.hidden) : g = ve.access(t, "fxshow", {}), r && (g.hidden = !h), h ? Z(t).show() : d.done(function () {
                    Z(t).hide()
                }), d.done(function () {
                    var e;
                    ve.remove(t, "fxshow");
        ...
        function _(t, e, n) {
            var i, o, r = 0, s = en.length, a = Z.Deferred().always(function () {
                ...
                elem: t, props: Z.extend({}, e), opts: Z.extend(!0, {specialEasing: {}}, n), originalProperties: e, originalOptions: n, startTime: Ye || D(), duration: n.duration, tweens: [], createTween: function (e, n) {
            ...
            for (I(u, c.opts.specialEasing); s > r; r++)if (i = en[r].call(c, t, u, c.opts))return i;
            return Z.map(u, j, c), Z.isFunction(c.opts.start) && c.opts.start.call(t, c), Z.fx.timer(Z.extend(l, {elem: t, anim: c, queue: c.opts.queue})), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always)
        }
        ...
        function L(t) {
            return function (e, n) {
                ...
                if (Z.isFunction(n))for (; i = r[o++];)"+" === i[0] ? (i = i.slice(1) || "*", (t[i] = t[i] || []).unshift(n)) : (t[i] = t[i] || []).push(n)
            }
        }
        ...
        function F(t, e, n, i) {
            ...
            if (Z.isArray(e))Z.each(e, function (e, o) {
                n || $n.test(t) ? i(t, o) : F(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            }); else if (n || "object" !== Z.type(e))i(t, e); else for (o in e)F(t + "[" + o + "]", e[o], n, i)
        }
        ...
        var M = [], U = M.slice, B = M.concat, z = M.push, V = M.indexOf, X = {}, Q = X.toString, G = X.hasOwnProperty, Y = {}, J = t.document, K = "2.1.3", Z = function (t, e) {
        ...
        Z.fn = Z.prototype = {
            ...
            for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || Z.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)if (null != (t = arguments[a]))for (e in t)n = s[e], i = t[e], s !== i && (c && i && (Z.isPlainObject(i) || (o = Z.isArray(i))) ? (o ? (o = !1, r = n && Z.isArray(n) ? n : []) : r = n && Z.isPlainObject(n) ? n : {}, s[e] = Z.extend(c, r, i)) : void 0 !== i && (s[e] = i));
            return s
        }, Z.extend({
            expando: "jQuery" + (K + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
                ...
                var n, i, o;
                return "string" == typeof e && (n = t[e], e = t, t = n), Z.isFunction(t) ? (i = U.call(arguments, 2), o = function () {
        ...
        var oe = function (t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : F) !== O && j(e), e = e || O, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a)return n;
                if (!i && _) {
                    ...
                    if (w.qsa && (!L || !L.test(t))) {
                        if (f = d = P, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = $(t), (d = e.getAttribute("id")) ? f = d.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + p(c[l]);
            ...
            function v(t, e, n, o, r, s) {
                return o && !o[P] && (o = v(o)), r && !r[P] && (r = v(r, s)), i(function (i, s, a, l) {
                    var c, u, d, p = [], f = [], h = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : m(v, p, t, a, l), b = n ? r || (i ? t : h || o) ? [] : s : y;
                    if (n && n(y, b, a, l), o)for (c = m(b, f), o(c, [], a, l), u = c.length; u--;)(d = c[u]) && (b[f[u]] = !(y[f[u]] = d));
                    if (i) {
                        if (r || t) {
                            if (r) {
            ...
            function y(t) {
                for (var e, n, i, o = t.length, r = T.relative[t[0].type], s = r || T.relative[" "], a = r ? 1 : 0, l = f(function (t) {
                    ...
                    return e = null, o
                }]; o > a; a++)if (n = T.relative[t[a].type])u = [f(h(u), n)]; else {
                    if (n = T.filter[t[a].type].apply(null, t[a].matches), n[P]) {
                        for (i = ++a; o > i && !T.relative[t[i].type]; i++);
                        return v(a > 1 && h(u), a > 1 && p(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(le, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && p(t))
                    }
                    u.push(n)
                }
                return h(u)
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, d, p, f = 0, h = "0", g = i && [], v = [], y = S, b = i || r && T.find.TAG("*", c), x = W += null == y ? 1 : Math.random() || .1, w = b.length;
                    for (c && (S = s !== O && s); h !== w && null != (u = b[h]); h++) {
                        if (r && u) {
            ...
            var x, w, T, C, k, $, E, N, S, D, A, j, O, I, _, L, R, H, q, P = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, U = n(), B = n(), z = n(), V = function (t, e) {
                return t === e && (A = !0), 0
            ...
            }, ge = /^(?:input|select|textarea|button)$/i, me = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, xe = /'|\\/g, we = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), Te = function (t, e, n) {
                var i = "0x" + e - 65536;
            ...
            w = e.support = {}, k = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), _ = !k(i), w.attributes = o(function (t) {
                ...
                }, R = [], L = [], (w.qsa = ve.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (w.matchesSelector = ve.test(H = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function (t) {
                    w.disconnectedMatch = H.call(t, "div"), H.call(t, "[s!='']:x"), R.push("!=", se)
                }), L = L.length && new RegExp(L.join("|")), R = R.length && new RegExp(R.join("|")), e = ve.test(I.compareDocumentPosition), q = e || ve.test(I.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === F && q(F, t) ? -1 : e === i || e.ownerDocument === F && q(F, e) ? 1 : D ? te(D, t) - te(D, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return A = !0, 0;
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !_ || R && R.test(n) || L && L.test(n)))try {
                    var i = H.call(t, n);
                ...
                return (t.ownerDocument || t) !== O && j(t), q(t, e)
            }, e.attr = function (t, e) {
                (t.ownerDocument || t) !== O && j(t);
                var n = T.attrHandle[e.toLowerCase()], i = n && Q.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !_) : void 0;
                ...
                cacheLength: 50, createPseudo: i, match: he, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return he.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && pe.test(n) && (e = $(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                }, filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var c, u, d, p, f, h, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                            if (m) {
                                if (r) {
                                    for (; g;) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[P] || (m[P] = {}), c = u[t] || [], f = c[0] === W && c[1], p = c[0] === W && c[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();)if (1 === d.nodeType && ++p && d === e) {
                                        u[t] = [W, f, p];
                                        break
                                    }
                                } else if (y && (c = (e[P] || (e[P] = {}))[t]) && c[0] === W)p = c[1]; else for (; (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[P] || (d[P] = {}))[t] = [W, p]), d !== e)););
                    ...
                    not: i(function (t) {
                        ...
                        return fe.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(we, Te).toLowerCase(), function (e) {
                            var n;
                            do if (n = _ ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))return n = n.toLowerCase(), n === t || 0 === n.indexOf(t + "-"); while ((e = e.parentNode) && 1 === e.nodeType);
                            return !1
                        }
                    }), target: function (e) {
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, $ = e.tokenize = function (t, n) {
                ...
                var n, i = [], o = [], r = z[t + " "];
                if (!r) {
                    for (e || (e = $(t)), n = e.length; n--;)r = y(e[n]), r[P] ? i.push(r) : o.push(r);
                    r = z(t, b(o, i)), r.selector = t
                }
                return r
            }, N = e.select = function (t, e, n, i) {
                var o, r, s, a, l, c = "function" == typeof t && t, d = !i && $(t = c.selector || t);
                if (n = n || [], 1 === d.length) {
                    if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && _ && T.relative[r[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(we, Te), e) || [])[0], !e)return n;
                        c && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = he.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((l = T.find[a]) && (i = l(s.matches[0].replace(we, Te), be.test(r[0].type) && u(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && p(r), !t)return K.apply(n, i), n;
                        break
                    }
                }
                return (c || E(t, d))(i, e, !_, n, be.test(t) && u(e.parentNode) || e), n
        ...
        var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ue = Z.fn.init = function (t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof Z ? e[0] : e, Z.merge(this, Z.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : J, !0)), se.test(n[1]) && Z.isPlainObject(e))for (n in e)Z.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                    return this
                }
        ...
        Z.extend({
            ...
            has: function (t) {
                var e = Z(t, this), n = e.length;
                return this.filter(function () {
                    for (var t = 0; n > t; t++)if (Z.contains(this, e[t]))return !0
                })
            }, closest: function (t, e) {
                for (var n, i = 0, o = this.length, r = [], s = re.test(t) || "string" != typeof t ? Z(t, e || this.context) : 0; o > i; i++)for (n = this[i]; n && n !== e; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && Z.find.matchesSelector(n, t))) {
                    r.push(n);
                    break
                }
            ...
            Z.fn[t] = function (n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (pe[t] || Z.unique(o), de.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var fe = /\S+/g, he = {};
        Z.Callbacks = function (t) {
            t = "string" == typeof t ? he[t] || r(t) : Z.extend({}, t);
            var e, n, i, o, s, a, l = [], c = !t.once && [], u = function (r) {
                ...
                add: function () {
                    ...
                    return l && Z.each(arguments, function (t, e) {
                        for (var n; (n = Z.inArray(e, l, n)) > -1;)l.splice(n, 1), i && (s >= n && s--, a >= n && a--)
                    }), this
                }, has: function (t) {
            ...
            Deferred: function (t) {
                var e = [["resolve", "done", Z.Callbacks("once memory"), "resolved"], ["reject", "fail", Z.Callbacks("once memory"), "rejected"], ["notify", "progress", Z.Callbacks("memory")]], n = "pending", i = {
                    state: function () {
                        return n
                    }, always: function () {
                ...
                var e, n, i, o = 0, r = U.call(arguments), s = r.length, a = 1 !== s || t && Z.isFunction(t.promise) ? s : 0, l = 1 === a ? t : Z.Deferred(), c = function (t, n, i) {
                    return function (o) {
                        n[t] = this, i[t] = arguments.length > 1 ? U.call(arguments) : o, i === e ? l.notifyWith(n, i) : --a || l.resolveWith(n, i)
                    }
                };
                if (s > 1)for (e = new Array(s), n = new Array(s), i = new Array(s); s > o; o++)r[o] && Z.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, e)) : --a;
        ...
        Z.acceptData = function (t) {
            ...
            key: function (t) {
                ...
                if ("string" == typeof e)r[e] = n; else if (Z.isEmptyObject(r))Z.extend(this.cache[o], e); else for (i in e)r[i] = e[i];
                return r
            }, get: function (t, e) {
        ...
        Z.extend({
            ...
            queue: function (t, e, n) {
                ...
                e = e || "fx";
                var n = Z.queue(t, e), i = n.length, o = n.shift(), r = Z._queueHooks(t, e), s = function () {
                    Z.dequeue(t, e)
                };
        ...
        var we = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Te = ["Top", "Right", "Bottom", "Left"], Ce = function (t, e) {
        ...
        var Ee = /^key/, Ne = /^(?:mouse|pointer|contextmenu)|click/, Se = /^(?:focusinfocus|focusoutblur)$/, De = /^([^.]*)(?:\.(.+)|)$/;
        Z.event = {
            global: {}, add: function (t, e, n, i, o) {
                var r, s, a, l, c, u, d, p, f, h, g, m = ve.get(t);
                if (m)for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                    return typeof Z !== $e && Z.event.triggered !== e.type ? Z.event.dispatch.apply(t, arguments) : void 0
                }), e = (e || "").match(fe) || [""], c = e.length; c--;)a = De.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = Z.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = Z.event.special[f] || {}, u = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (p = l[f]) || (p = l[f] = [], p.delegateCount = 0, d.setup && d.setup.call(t, i, h, s) !== !1 || t.addEventListener && t.addEventListener(f, s, !1)), d.add && (d.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), Z.event.global[f] = !0)
            }, remove: function (t, e, n, i, o) {
                var r, s, a, l, c, u, d, p, f, h, g, m = ve.hasData(t) && ve.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(fe) || [""], c = e.length; c--;)if (a = De.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                        for (d = Z.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;)u = p[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(t, u));
                        s && !p.length && (d.teardown && d.teardown.call(t, h, m.handle) !== !1 || Z.removeEvent(t, f, m.handle), delete l[f])
                    } else for (f in l)Z.event.remove(t, f + e[c], n, i, !0);
                    Z.isEmptyObject(l) && (delete m.handle, ve.remove(t, "events"))
                }
            }, trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, d, p = [i || J], f = G.call(e, "type") ? e.type : e, h = G.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), d = Z.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                    ...
                    for (r = 0; (s = p[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : d.bindType || f, u = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
                    return e.type = f, o || e.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[f]) && !Z.isWindow(i) && (a = i[c], a && (i[c] = null), Z.event.triggered = f, i[f](), Z.event.triggered = void 0, a && (i[c] = a)), e.result
                }
            }, dispatch: function (t) {
                t = Z.event.fix(t);
                var e, n, i, o, r, s = [], a = U.call(arguments), l = (ve.get(this, "events") || {})[t.type] || [], c = Z.event.special[t.type] || {};
                if (a[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
                    for (s = Z.event.handlers.call(this, t, l), e = 0; (o = s[e++]) && !t.isPropagationStopped();)for (t.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(r.namespace)) && (t.handleObj = r, t.data = r.data, i = ((Z.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                for (s || (this.fixHooks[o] = s = Ne.test(o) ? this.mouseHooks : Ee.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, je = /<([\w:]+)/, Oe = /<|&#?\w+;/, Ie = /<(?:script|style|link)/i, _e = /checked\s*(?:[^=]|=\s*.checked.)/i, Le = /^$|\/(?:java|ecma)script/i, Re = /^true\/(.*)/, He = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, qe = {
        ...
        qe.optgroup = qe.option, qe.tbody = qe.tfoot = qe.colgroup = qe.caption = qe.thead, qe.th = qe.td, Z.extend({
            clone: function (t, e, n) {
                ...
                if (!(Y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || Z.isXMLDoc(t)))for (s = v(a), r = v(t), i = 0, o = r.length; o > i; i++)y(r[i], s[i]);
                ...
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; f > p; p++)if (o = t[p], o || 0 === o)if ("object" === Z.type(o))Z.merge(d, o.nodeType ? [o] : o); else if (Oe.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), s = (je.exec(o) || ["", ""])[1].toLowerCase(), a = qe[s] || qe._default, r.innerHTML = a[1] + o.replace(Ae, "<$1></$2>") + a[2], c = a[0]; c--;)r = r.lastChild;
                    Z.merge(d, r.childNodes), r = u.firstChild, r.textContent = ""
                } else d.push(e.createTextNode(o));
                for (u.textContent = "", p = 0; o = d[p++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))for (c = 0; o = r[c++];)Le.test(o.type || "") && n.push(o);
                return u
            }, cleanData: function (t) {
                for (var e, n, i, o, r = Z.event.special, s = 0; void 0 !== (n = t[s]); s++) {
                    if (Z.acceptData(n) && (o = n[ve.expando], o && (e = ve.cache[o]))) {
                        if (e.events)for (i in e.events)r[i] ? Z.event.remove(n, i) : Z.removeEvent(n, i, e.handle);
            ...
            text: function (t) {
                ...
                return me(this, function (t) {
                    ...
                    if ("string" == typeof t && !Ie.test(t) && !qe[(je.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Ae, "<$1></$2>");
                        try {
                ...
                t = B.apply([], t);
                var n, i, o, r, s, a, l = 0, c = this.length, u = this, d = c - 1, p = t[0], g = Z.isFunction(p);
                if (g || c > 1 && "string" == typeof p && !Y.checkClone && _e.test(p))return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    for (o = Z.map(v(n, "script"), f), r = o.length; c > l; l++)s = n, l !== d && (s = Z.clone(s, !0, !0), r && Z.merge(o, v(s, "script"))), e.call(this[l], s, l);
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++)s = o[l], Le.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(He, "")))
                }
                return this
            }
        ...
        var Pe, Fe = {}, We = /^margin/, Me = new RegExp("^(" + we + ")(?!px)[a-z%]+$", "i"), Ue = function (e) {
        ...
        var Be = /^(none|table(?!-c[ea]).+)/, ze = new RegExp("^(" + we + ")(.*)$", "i"), Ve = new RegExp("^([+-])=(" + we + ")", "i"), Xe = {position: "absolute", visibility: "hidden", display: "block"}, Qe = {letterSpacing: "0", fontWeight: "400"}, Ge = ["Webkit", "O", "Moz", "ms"];
        Z.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
                ...
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    return e = Z.cssProps[a] || (Z.cssProps[a] = C(l, a)), s = Z.cssHooks[e] || Z.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Ve.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)), r = "number"), null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"), Y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set"in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n)), void 0)
                }
            }, css: function (t, e, n, i) {
                var o, r, s, a = Z.camelCase(e);
                return e = Z.cssProps[a] || (Z.cssProps[a] = C(t.style, a)), s = Z.cssHooks[e] || Z.cssHooks[a], s && "get"in s && (o = s.get(t, !0, n)), void 0 === o && (o = w(t, e, i)), "normal" === o && e in Qe && (o = Qe[e]), "" === n || n ? (r = parseFloat(o), n === !0 || Z.isNumeric(r) ? r || 0 : o) : o
            }
        }), Z.each(["height", "width"], function (t, e) {
            Z.cssHooks[e] = {
                get: function (t, n, i) {
                    return n ? Be.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Xe, function () {
                        return E(t, e, i)
                    }) : E(t, e, i) : void 0
                }, set: function (t, n, i) {
                    var o = i && Ue(t);
        ...
        }), Z.cssHooks.marginRight = T(Y.reliableMarginRight, function (t, e) {
            ...
            css: function (t, e) {
                return me(this, function (t, e, n) {
                    var i, o, r = {}, s = 0;
                    if (Z.isArray(e)) {
                        for (i = Ue(t), o = e.length; o > s; s++)r[e[s]] = Z.css(t, e[s], !1, i);
                        return r
                    }
            ...
            constructor: S, init: function (t, e, n, i, o, r) {
                ...
                return this.pos = e = this.options.duration ? Z.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : S.propHooks._default.set(this), this
            }
        ...
        var Ye, Je, Ke = /^(?:toggle|show|hide)$/, Ze = new RegExp("^(?:([+-])=|)(" + we + ")([a-z%]*)$", "i"), tn = /queueHooks$/, en = [O], nn = {
            "*": [function (t, e) {
                var n = this.createTween(t, e), i = n.cur(), o = Ze.exec(e), r = o && o[3] || (Z.cssNumber[t] ? "" : "px"), s = (Z.cssNumber[t] || "px" !== r && +i) && Ze.exec(Z.css(n.elem, t)), a = 1, l = 20;
                if (s && s[3] !== r) {
                    r = r || s[3], o = o || [], s = +i || 1;
        ...
        Z.Animation = Z.extend(_, {
            ...
            fadeTo: function (t, e, n, i) {
                ...
                var o = Z.isEmptyObject(t), r = Z.speed(e, n, i), s = function () {
                ...
                return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                    var e = !0, o = null != t && t + "queueHooks", r = Z.timers, s = ve.get(this);
        ...
        Z.fn.extend({
            ...
            attr: function (t, e, n) {
                ...
                if (t && 3 !== r && 8 !== r && 2 !== r)return typeof t.getAttribute === $e ? Z.prop(t, e, n) : (1 === r && Z.isXMLDoc(t) || (e = e.toLowerCase(), i = Z.attrHooks[e] || (Z.expr.match.bool.test(e) ? rn : on)), void 0 === n ? i && "get"in i && null !== (o = i.get(t, e)) ? o : (o = Z.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set"in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void Z.removeAttr(t, e))
        ...
        Z.fn.extend({
            addClass: function (t) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ? function (n) {
                    ...
                    if ("string" === n)for (var e, i = 0, o = Z(this), r = t.match(fe) || []; e = r[i++];)o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else(n === $e || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ve.get(this, "__className__") || "")
                })
            }, hasClass: function (t) {
        ...
        Z.fn.extend({
            val: function (t) {
                var e, n, i, o = this[0];
                {
                    ...
                    if (o)return e = Z.valHooks[o.type] || Z.valHooks[o.nodeName.toLowerCase()], e && "get"in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(cn, "") : null == n ? "" : n)
                }
            }
        }), Z.extend({
            valHooks: {
                option: {
                    ...
                    get: function (t) {
                        for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)if (n = i[l], !(!n.selected && l !== o || (Y.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
        ...
        var pn = /#.*$/, fn = /([?&])_=[^&]*/, hn = /^(.*?):[ \t]*([^\r\n]*)$/gm, gn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, mn = /^(?:GET|HEAD)$/, vn = /^\/\//, yn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, bn = {}, xn = {}, wn = "*/".concat("*"), Tn = t.location.href, Cn = yn.exec(Tn.toLowerCase()) || [];
        Z.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, u, v, y, x, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", w.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = q(d, w, n)), y = P(d, y, w, l), l ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (Z.etag[o] = x)), 204 === t || "HEAD" === d.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, u = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || T) + "", l ? h.resolveWith(p, [u, T, w]) : h.rejectWith(p, [w, T, v]), w.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [w, d, l ? u : v]), g.fireWith(p, [w, T]), c && (f.trigger("ajaxComplete", [w, d]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, c, u, d = Z.ajaxSetup({}, e), p = d.context || d, f = d.context && (p.nodeType || p.jquery) ? Z(p) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = d.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0,
                    getResponseHeader: function (t) {
                        var e;
                        if (2 === b) {
                            if (!s)for (s = {}; e = hn.exec(r);)s[e[1].toLowerCase()] = e[2];
                            e = s[t.toLowerCase()]
                        }
                ...
                if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Tn) + "").replace(pn, "").replace(vn, Cn[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(fe) || [""], null == d.crossDomain && (l = yn.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === Cn[1] && l[2] === Cn[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Cn[3] || ("http:" === Cn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = Z.param(d.data, d.traditional)), R(bn, d, e, w), 2 === b)return w;
                c = Z.event && d.global, c && 0 === Z.active++ && Z.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !mn.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (dn.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = fn.test(o) ? o.replace(fn, "$1_=" + un++) : o + (dn.test(o) ? "&" : "?") + "_=" + un++)), d.ifModified && (Z.lastModified[o] && w.setRequestHeader("If-Modified-Since", Z.lastModified[o]), Z.etag[o] && w.setRequestHeader("If-None-Match", Z.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + wn + "; q=0.01" : "") : d.accepts["*"]);
            ...
            Z[e] = function (t, n, i, o) {
                return Z.isFunction(n) && (o = o || i, i = n, n = void 0), Z.ajax({url: t, type: e, dataType: o, data: n, success: i})
            }
        ...
        var kn = /%20/g, $n = /\[\]$/, En = /\r?\n/g, Nn = /^(?:submit|button|image|reset|file)$/i, Sn = /^(?:input|select|textarea|keygen)/i;
        Z.param = function (t, e) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !Z(this).is(":disabled") && Sn.test(this.nodeName) && !Nn.test(t) && (this.checked || !ke.test(t))
                }).map(function (t, e) {
                    var n = Z(this).val();
        ...
        var Dn = 0, An = {}, jn = {0: 200, 1223: 204}, On = Z.ajaxSettings.xhr();
        t.attachEvent && t.attachEvent("onunload", function () {
            for (var t in An)An[t]()
        }), Y.cors = !!On && "withCredentials"in On, Y.ajax = On = !!On, Z.ajaxTransport(function (t) {
            var e;
            return Y.cors || On && !t.crossDomain ? {
                send: function (n, i) {
                    var o, r = t.xhr(), s = ++Dn;
                    ...
                    e = function (t) {
                        return function () {
                            e && (delete An[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(jn[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {text: r.responseText} : void 0, r.getAllResponseHeaders()))
                        }
        ...
        Z.ajaxSetup({
            jsonp: "callback", jsonpCallback: function () {
                var t = In.pop() || Z.expando + "_" + un++;
                return this[t] = !0, t
            }
        }), Z.ajaxPrefilter("json jsonp", function (e, n, i) {
            var o, r, s, a = e.jsonp !== !1 && (_n.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && _n.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(_n, "$1" + o) : e.jsonp !== !1 && (e.url += (dn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return s || Z.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
                s = arguments
            }, i.always(function () {
                t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, In.push(o)), s && Z.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        Z.fn.load = function (t, e, n) {
            ...
            return a >= 0 && (i = Z.trim(t.slice(a)), t = t.slice(0, a)), Z.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), s.length > 0 && Z.ajax({url: t, type: o, dataType: "html", data: e}).done(function (t) {
        ...
        Z.offset = {
            setOffset: function (t, e, n) {
                var i, o, r, s, a, l, c, u = Z.css(t, "position"), d = Z(t), p = {};
            ...
            offset: function (t) {
                ...
                if (r)return e = r.documentElement, Z.contains(e, i) ? (typeof i.getBoundingClientRect !== $e && (o = i.getBoundingClientRect()), n = W(r), {top: o.top + n.pageYOffset - e.clientTop, left: o.left + n.pageXOffset - e.clientLeft}) : o
            }, position: function () {
                if (this[0]) {
            ...
            Z.cssHooks[e] = T(Y.pixelPosition, function (t, n) {
                return n ? (n = w(t, e), Me.test(n) ? Z(t).position()[e] + "px" : n) : void 0
            })
        ...
        var Hn = t.jQuery, qn = t.$;
        return Z.noConflict = function (e) {
            return t.$ === Z && (t.$ = qn), e && t.jQuery === Z && (t.jQuery = Hn), Z
        }, typeof e === $e && (t.jQuery = t.$ = Z), Z
...
+function (t) {
    ...
    n.VERSION = "3.3.2", n.TRANSITION_DURATION = 600, n.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0, keyboard: !0}, n.prototype.keydown = function (t) {
    ...
    i.VERSION = "3.3.2", i.TRANSITION_DURATION = 350, i.DEFAULTS = {toggle: !0, trigger: '[data-toggle="collapse"]'}, i.prototype.dimension = function () {
    ...
    t.fn.collapse = n, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function () {
        ...
        var r = e(o), s = r.data("bs.collapse"), a = s ? "toggle" : t.extend({}, o.data(), {trigger: this});
        n.call(r, a)
    })
}(jQuery), +function (t) {
    "use strict";
    ...
    n.prototype.init = function () {
        ...
        i.toggle && n.attr("data-toggle", i.toggle), n.on("click", ".list-group-item", function () {
            var o = t(this);
            return o.hasClass("disabled") || ("items" == n.data("toggle") ? o.toggleClass("active") : e.unselect("*").select(o), i.click && i.click.apply(this)), o.blur(), !1
        })
    }, n.prototype.select = function (e) {
        var n, i;
        if (e instanceof t && e.addClass("active"), "string" == typeof e && (e = [e]), Array.isArray(e))for (n in e)i = e[n], this.$element.find(".list-group-item[data-value='" + i + "']").addClass("active");
        return this
    }, n.prototype.unselect = function (t) {
        return this.$element.find(".list-group-item").filter(t || "*").removeClass("active"), this
    }, e = function (e, n) {
        this.$element = t(e), this.options = n, this.$listGroup = this.createListGroup()
        ...
        var e, n = this.$element.val();
        Array.isArray(n) || (n = [n]), Array.isArray(t) || (t = [t]);
        for (e in t)n.pop(t[e]);
        this.$element.val(n).change()
    }, e.prototype.createListGroup = function () {
        var e = this.$element, n = t("<ul>").addClass("list-group");
        return e.attr("multiple") && n.attr("data-toggle", "items"), e.find("option").each(function (e, i) {
            var o = t(i), r = t("<a>").attr("href", "#").addClass("list-group-item").attr("data-value", o.val()).text(o.text());
            o.is(":disabled") && r.addClass("disabled"), "none" === o.css("display") && r.addClass("hidden"), n.append(r)
        }), e.change(function () {
            n.listgroup({unselect: "*", select: e.val()})
        }), n.listgroup({
            select: e.val(), click: function () {
                var i = [];
                n.find(".list-group-item.active").each(function (e, n) {
                    var o = t(n).data("value");
                    i.push(o)
                }), 1 == i.length && (i = i[0]), e.val(i)
            }
        }), e.before(n), this.$listGroup = n, e.hide(), n
    }, t.fn.listgroup = function (i) {
        return this.each(function (o, r) {
            var s = t(r), a = s.data("listgroup");
            a || s.data("listgroup", a = s.is("select") ? new e(r, i) : new n(r, i)), i && (i.unselect && a.unselect(i.unselect), i.select && a.select(i.select))
        })
    }, t(function () {
        t(".list-group").listgroup(), $(document).bind("ajaxComplete", function () {
            t(".list-group").listgroup()
    ...
    $("[data-href]") && $("[data-href]").load($("[data-href]").data("href"), function () {
        $(".list-group.checked-list-box .list-group-item").init()
    }), $("[data-target]") && $(document).on("click", "[data-target]", function (t) {
        $($(this).data("target")).load($(this).attr("href")), t.preventDefault()
    }), $("document").on("click", ".load-branches", function (t) {
        t.preventDefault(), alert("AQUI")
    })
});